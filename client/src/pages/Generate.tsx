            ...
            <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                <div>
                  ...
                  <p className="text-sm text-zinc-400">Desceibe your vision and let AI bring it to life.</p>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="space-y-2">
                    <label className="block text-sm font-medium">
                      Additional Prompts <span className="text-zinc-400 text-sm">(optional)</span>
                    </label>
                ...
                {/* BUTTON */}
                {!id && (
                  <button onClick={handleGenerate} className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-pink-500  to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed">
